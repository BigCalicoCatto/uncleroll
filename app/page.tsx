  ...
  return (
    <div style={{ fontFamily: "system-ui, -apple-system, sans-serif" }}>
      ...
      >
        ...
        {menuOpen && (
          ...
          >
            ...
            <button
              onClick={() => scrollToSection(sections.delivery)}
              style={{
                background: "none",
                border: "none",
                fontSize: "1rem",
      ...
      <div ref={sections.reviews} id="reviews" className={animatedSections['reviews'] ? 'fade-in-up' : ''} style={{ backgroundColor: "#ffffff", width: "100%", padding: "2rem 1rem" }}>
        <h2 style={{ fontSize: "1.5rem", fontWeight: "bold", margin: "0 0 1.5rem 0", textAlign: "center", color: "#22c55e" }}>Apa kata pelanggan setia kami</h2>
      ...
      <div ref={sections.delivery} id="delivery" className={animatedSections['delivery'] ? 'fade-in-up' : ''} style={{ backgroundColor: "#ffffff", width: "100%", padding: "2rem 1rem", textAlign: "center" }}>
        <h2 style={{ fontSize: "1.8rem", fontWeight: "bold", margin: "0 0 1.5rem 0", color: "#22c55e" }}>Anda order, Kami hantar!</h2>
      ...
      {/* FOOTER */}
      <div style={{ backgroundColor: "#22c55e", width: "100%", padding: "2rem 1rem", textAlign: "center", color: "white", fontSize: "0.85rem" }}>
